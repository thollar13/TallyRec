...
ob_start();
    ...
    echo "<li data-role='list-divider'>My Teams</li>";
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            if($row["SportID"]=="100") {
                echo "<img src='http://mobile.tallyrec.com/images/sport/default.png' alt='' class='ui-li-icon' />";
            }
            else if ($row["SportID"]=="19") {
                     echo "<img src='http://mobile.tallyrec.com/images/sport/19.png' alt='' class='ui-li-icon' />";
                 }
            else{

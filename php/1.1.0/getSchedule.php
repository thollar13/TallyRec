                ...
                echo "<li class='ui-field-contain ui-body ui-br ui-btn-up-c ui-corner-top'>";
                    echo "<table style='width:100%;'>";
                        echo "<tr>";
                            ...
                            echo "<td>";
                                if ($TeamManageID == "1") {
                                    echo "<a data-role='button' class='EditGameBtn' data-gameid='" . $row['GameID'] . "' data-opponent='" . htmlspecialchars($row["Opponent"], ENT_QUOTES) . "' data-date='" . $row['Date'] . "' data-time='" . $row['Time'] . "' data-park='" . htmlspecialchars($row['Park'], ENT_QUOTES) . "' data-homeaway='" . $row['HomeAway'] . "' data-city='" . htmlspecialchars($row['City'], ENT_QUOTES) . "' data-state='" . $row['State'] . "' data-homescore='" . $row['HomeScore'] . "' data-awayscore='" . $row['AwayScore'] . "' data-iconpos='notext' data-icon='arrow-r' data-mini='true' data-inline='true' style='font-size: 6pt; color: #48739d; margin-right: 3px;'>Edit</a>";
                                }
                                else {
                                    echo "&nbsp";
                                }

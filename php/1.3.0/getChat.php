...
$managercode = $_REQUEST['TeamManageID'];

if ($managercode == "0" || $managercode == "1") {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            if ($row['UserID'] == $userid) {
                ...
                echo "<div id='chatSender'>";
                        echo "<p class='chatTimeStampRecipient' style='font-size:1em;'><span style='font-size: 1em;'>";
                            //Time
                    ...
                    echo "<table class='rightchat'>";
                        echo "<tr>";
                            echo "<td style='text-align:right;font-size:1em;font-weight:bold;'>";
                                // Name
                ...
                echo "<div id='chatRecipient'>";
                    echo "<p class='chatTimeStampSender' style='font-size:1em;'>";
                    ...
                    echo "<table class='leftchat'>";
                        echo "<tr>";
                            echo "<td style='text-align: left; font-size:1em; font-weight: bold;'> &nbsp;";
                                // Name
                                echo $row['Fname'] . " " . $row['Lname'];
                                echo "<hr />";
                            echo "</td>";

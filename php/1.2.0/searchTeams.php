...
if($count==0){
    ...
    echo "<br />";
    echo "<ul data-role='listview' style='font-size: 8pt;' data-inset='true' data-inline='true' data-filter='true' data-mini='true' id='searchteams' data-filter-placeholder='Filter Teams'>";
    ...
    while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<li data-filtertext=''>";
                ...
                echo "</span></div>";
                echo "<div class='ui-block-b' style='text-align: right;'><a class='FollowTeam' data-teamid='" . $row['TeamID'] . "' data-teamname='" . $row['Name'] . "' data-mini='true' data-role='button' data-inline='true'>Follow</a></div>";
                echo "</div>";
            echo "</li>";
    }
